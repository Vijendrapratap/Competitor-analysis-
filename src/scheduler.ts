...
async function runScrapeStage(): Promise<void> {
...
async function runAnalysisStage(): Promise<void> {
...
async function runGenerateStage(): Promise<void> {
...
async function runDeliverStage(): Promise<void> {
...
async function sendErrorNotification(error: string, stage: string): Promise<void> {
  try {

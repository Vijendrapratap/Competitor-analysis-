...
// =============================================================================
import { boolean, date, index, integer, jsonb, numeric, pgTable, serial, text, timestamp, uniqueIndex, uuid, varchar, } from 'drizzle-orm/pg-core';
// ─────────────────────────────────────────────────────────────────────────────
// 1. COMPETITORS
// ─────────────────────────────────────────────────────────────────────────────
...
export const facebookPages = pgTable('facebook_pages', {
    ...
    index('facebook_pages_competitor_scraped_idx').on(table.competitorId, table.scrapedAt),
]);
// ─────────────────────────────────────────────────────────────────────────────
// 4. FACEBOOK POSTS
// ─────────────────────────────────────────────────────────────────────────────
export const facebookPosts = pgTable('facebook_posts', {
    ...
    index('facebook_posts_competitor_posted_idx').on(table.competitorId, table.postedAt),
...
export const analyses = pgTable('analyses', {
    ...
    adTypes: jsonb('ad_types').$type().notNull().default([]),
    ...
    uniqueIndex('analyses_competitor_date_idx').on(table.competitorId, table.analysisDate),
...
export const trends = pgTable('trends', {
    ...
    uniqueIndex('trends_date_source_keyword_idx').on(table.trendDate, table.source, table.keyword),
]);
// ─────────────────────────────────────────────────────────────────────────────
// 7. ALERTS
// ─────────────────────────────────────────────────────────────────────────────
...
export const reportCompetitors = pgTable('report_competitors', {
    id: serial('id').primaryKey(),
    ...
    newestAdDate: date('newest_ad_date', { mode: 'date' }),
    adTypes: jsonb('ad_types').$type().notNull().default([]),
    targetSegments: jsonb('target_segments').$type().notNull().default([]),
    keyUspEn: text('key_usp_en'),
    marketingStrategyEn: text('marketing_strategy_en'),
...
export const followerHistory = pgTable('follower_history', {
    ...
    uniqueIndex('follower_history_competitor_date_idx').on(table.competitorId, table.recordedDate),

...
import { getUnsentAlerts, markAlertSent, markReportDelivered, } from '../db/queries.js';
...
export class DeliveryService {
    ...
    async run(opts = {}) {
        ...
        try {
            ...
            const criticalAlerts = unsentAlerts.filter((a) => a.severity === AlertSeverity.Critical);
     ...
     */
    async deliverReport(pdfPath, summary) {

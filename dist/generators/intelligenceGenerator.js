...
// ─────────────────────────────────────────────────────────────────────────────
export function calculateHealthScore(adCount, newestAdAgeDays, maxAdVariations, strategyCount, engagementRate = 0.0, marketLeaderAds = 31) {
    /**
...
// ─────────────────────────────────────────────────────────────────────────────
export function calculateShareOfVoice(competitors) {
    /**
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildActivityTimeline(competitors, reportDate = new Date()) {
    /**
...
export function buildSegmentMatrix(competitors, segmentData = null) {
    if (segmentData) {
        const rows = [];
        for (const [segName, data] of Object.entries(segmentData)) {
...
// Main Generator
// ─────────────────────────────────────────────────────────────────────────────
export function generateIntelligenceSections(reportData, intelligence) {
    ...
    for (const c of competitors) {
        ...
        if (suppliedScores[name] !== undefined) {
            ...
            let variations = 0;
            if (c.ad_variations) {
                variations = Math.max(...Object.values(c.ad_variations), 0);
            }
...
//# sourceMappingURL=intelligenceGenerator.js.map